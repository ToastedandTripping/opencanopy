...
| T2 | M | Layer named "Old Growth Forest" shows 7–29 % of land; story's last number is 0.3 %. | Rename → "Stands 250+ yr (VRI)". Big-tree subset layer if `SITE_INDEX` survives in tiles (else data item). SITE_INDEX absent from VRI extract — needs data pull (Batch 4). | 1 (copy: done) / 4 (data) | copy done, data open |
