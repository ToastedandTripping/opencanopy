...
const LAYER_CONFIG: Record<string, WFSLayerConfig> = {
  ...
  "conservation-priority": {
    url: "https://openmaps.gov.bc.ca/geo/pub/WHSE_LAND_USE_PLANNING.OGSR_TAP_PRIORITY_DEF_AREA_CUR_SP/ows",
...
const PROPERTY_WHITELIST: Record<string, string[]> = {
  ...
  "conservation-priority": [
    "PRIORITY_DEFERRAL_ID", "DEFERRAL_STATUS", "LANDSCAPE_UNIT_NAME",
    "ANCIENT_FLAG", "BEC_ZONE_CODE", "AREA_HA",
  ],
};
