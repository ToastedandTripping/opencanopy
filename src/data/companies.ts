...
export const COMPANY_REGISTRY: CompanyProfile[] = [
  ...
  { id: "tolko", clientNumbers: ["00147603"], displayName: "Tolko", color: "#7c3aed" },
  ...
  { id: "bc-timber-sales", clientNumbers: ["00109260"], displayName: "BC Timber Sales", color: "#0d9488" },
  ...
  { id: "teal-jones", clientNumbers: ["00007629"], displayName: "Teal Jones", color: "#4f46e5" },
