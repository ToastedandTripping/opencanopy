...
export function formatPropertyName(key: string): string {
  const labels: Record<string, string> = {
    ...
    DISTURBANCE_START_DATE: "Disturbance Date",
...
/** Properties to show, in priority order (shared with the schema audit). */
const PRIORITY_KEYS: readonly string[] = POPUP_PRIORITY_KEYS;
